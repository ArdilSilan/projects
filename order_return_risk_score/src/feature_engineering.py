...
class FeatureEngineer:
    ...
    def prepare_model_data(self, df):
        feature_columns = ['unit_price', 'quantity', 'discount', 'total_amount', 'discount_amount', 'avg_order_amount', 'std_order_amount', 'total_spent', 'avg_discount', 'max_discount', 'avg_quantity', 'total_quantity']
